...
onClick=(props )=>{
    ...
    this.setState({
      ...
      // click: this.props.click + 1,
      // name: this.props.name === 'imges1',
      isClicked: state.clicked = 1 
  ...
  return (
              <div className={st.Galerea}>
                      ...
                      {/* <DesignItem/> */}
                                        ...
                                        <div className={st.design1} onClick = {this.onClick}  title='imges1'>
                                        <img alt ='id' src ={imges1}  title='imges1'></img></div>
